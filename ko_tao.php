...
require_once 'strings.php'; 
    ...
    $koTaoHeaderSection = new HeaderSection('Koh Tao', '', []);

    echo Utils::getStandardHeaderWithImage([$koTaoHeaderSection], 'Koh Tao.jpg', ['articleCentered'], 'linear-gradient(112.5deg, rgba(92, 177, 168, 0.7) 85%, transparent 15%)', 'islandsDropdown');
